...
namespace WpfApplication1 {
    ...
    public partial class BaseDataSet : global::System.Data.DataSet {
        ...
        public partial class TestTableDataTable : global::System.Data.TypedTableBase<TestTableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public TestTableRow AddTestTableRow(string Name, int Age) {
...
namespace WpfApplication1.BaseDataSetTableAdapters {
    ...
    public partial class TestTableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[TestTable] ([Id], [Name], [Age]) VALUES (@Id, @Name, @Age);\r\nS" +
                "ELECT Id, Name, Age FROM TestTable WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[TestTable] SET [Id] = @Id, [Name] = @Name, [Age] = @Age WHERE (([Id] = @Original_Id) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Age = 1 AND [Age] IS NULL) OR ([Age] = @Original_Age)));
SELECT Id, Name, Age FROM TestTable WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, Age FROM dbo.TestTable";
        ...
        public virtual int Fill(BaseDataSet.TestTableDataTable dataTable) {
        ...
        public virtual BaseDataSet.TestTableDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            BaseDataSet.TestTableDataTable dataTable = new BaseDataSet.TestTableDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(BaseDataSet.TestTableDataTable dataTable) {
